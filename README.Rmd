...
OPUY provides a set of Uruguay's public opinion data since 1989. The data features two relevant indicators for the study of the Uruguay's political behavior: __vote intention__ and __presidential approval__.

The package manual can be found [__here__](https://github.com/Nicolas-Schmidt/opuy/blob/master/man/figures/Manual_opuy.pdf).
