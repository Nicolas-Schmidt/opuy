...
*Nicolás Schmidt, Daniela Vairo, UMAD<sup><a id="fnr.1" class="footref" href="#fn.1">1</a></sup>.*
...
Provee un conjunto de datos de opinión publica en Uruguay en el periodo que va desde 1989 hasta 2020.
...
| Nombre |Descripción |
| ----------------- | -------------------------------------------------------------- | 
|`opuy`|Conjunto de datos que contiene dos indicadores de opinión pública relevante para trabajar con datos políticos para el período 1989 - 2020: __Intención de voto__ y __Evaluación dela gestión del Presidente__. Los valores para ambos indicadores son agregados ya que no se cuenta con los microdatos. La fuente de los datos es el Banco de Datos de la Faculta de Ciencias Sociales (UMAD).|
